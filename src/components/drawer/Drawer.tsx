...
<!-- drawer component -->
<div id="drawer-body-scrolling" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 transition-transform left-0 top-0 transform-none" tabindex="-1" aria-labelledby="drawer-body-scrolling-label" aria-modal="true" role="dialog">
